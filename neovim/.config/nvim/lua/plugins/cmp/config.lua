  ...
  require('utils').set_highlight_groups(
    {
      0,
      'CmpGhostText',
      { fg = require('nightfox.palette').load('carbonfox').comment },
    },
    {
      0,
      'CmpCmdlineFloatBorder',
      { fg = require('nightfox.palette').load('carbonfox').blue.base },
    },
    {
      0,
      'CmpCmdlineCursorLine',
      { sp = require('nightfox.palette').load('carbonfox').blue.base, underline = true },
    }
  )
end
